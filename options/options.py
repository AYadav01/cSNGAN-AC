...
"""
Reads the json configuration file and loads the dictionary into an 'OrderedDict()'. 
e.g. OrderedDict([('name', '3DGAN_A01'), ('use_tb_logger', True), ...])
"""
def parse(opt_path, is_train=True):
    ...
    if is_train:
        experiments_root = os.path.join(opt['path']['root'], 'experiments_RSNA', opt['name'])
        ...
        results_root = opt['path']['results_dir']
